# CHIP-2022-02-CashTokens: Token Primitives for Bitcoin Cash
        ...
        Latest Revision Date: 2022-06-30
...
Numeric commitments are a specialization of byte-string commitments – they are commitments with numeric values which can be divided and merged in the same way as the Bitcoin Cash currency. With numeric commitments, contracts can represent fractional parts of abstract concepts – shares, pegged assets, bonds, loans, options, tickets, loyalty points, voting outcomes, etc.
...
2. `<has_nft>` – A byte indicating the presences and capability of a non-fungible token:
   ...
   2. `0xff` – the **`minting` capability** – the encoded non-fungible token is a **minting token**.
   3. `0xee` – the **`mutable` capability** – the encoded non-fungible token is a **mutable token**.
...
| 0-byte, mutable NFT; 0 fungible                    | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee0000`                                                                                                 |
| 0-byte, mutable NFT; 4294967295 fungible           | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee00feffffffff`                                                                                         |
| 1-byte, mutable NFT; 4294967296 fungible           | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee01ccff0000000001000000`                                                                               |
| 2-byte, mutable NFT; 9223372036854775807 fungible  | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee02ccccffffffffffffffff7f`                                                                             |
| 10-byte, mutable NFT; 1 fungible                   | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee0acccccccccccccccccccc01`                                                                             |
| 40-byte, mutable NFT; 252 fungible                 | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee28ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccfc`                 |
| 0-byte, minting NFT; 0 fungible                    | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff0000`                                                                                                 |
| 0-byte, minting NFT; 253 fungible                  | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff00fdfd00`                                                                                             |
| 1-byte, minting NFT; 65535 fungible                | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff01ccfdffff`                                                                                           |
| 2-byte, minting NFT; 65536 fungible                | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff02ccccfe00000100`                                                                                     |
| 10-byte, minting NFT; 4294967297 fungible          | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff0accccccccccccccccccccff0100000001000000`                                                             |
| 40-byte, minting NFT; 9223372036854775807 fungible | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff28ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccffffffffffffffff7f` |
...
| 41-byte, mutable NFT; 252 fungible                 | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee29ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccfc`                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 41-byte, minting NFT; 9223372036854775807 fungible | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff29ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccffffffffffffffff7f`                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 253-byte, immutable NFT; 0 fungible                | `` |
...
| Commitment length must be specified (mutable token)                                                    | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee`                   |
| Commitment length must be specified (minting token)                                                    | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff`                   |
...
| Not enough bytes remaining in locking bytecode to satisfy commitment length (mutable token, 1/2 bytes) | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee02cc`               |
| Not enough bytes remaining in locking bytecode to satisfy commitment length (mutable token, 0/1 bytes) | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff01`                 |
| Not enough bytes remaining in locking bytecode to satisfy commitment length (minting token, 1/2 bytes) | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dff02cc`               |
...
| -------------------------- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OP_UTXOTOKENCATEGORY`     | `0xce` (`206`) | Pop the top item from the stack as an input index (VM Number). Push the concatenation of the token category and capability of the Unspent Transaction Output (UTXO) spent by that input to the stack, where the minting capability is represented by `0xff`, the mutable capability is represented by `0xee`, and no capability is represented by 0 (VM Number). If the UTXO includes no tokens, push a 0 (VM Number). |
...
| `OP_OUTPUTTOKENCATEGORY`   | `0xd1` (`209`) | Pop the top item from the stack as an output index (VM Number). Push the concatenation of the token category and capability of the output at that index to the stack, where the minting capability is represented by `0xff`, the mutable capability is represented by `0xee`, and no capability is represented by 0 (VM Number). If the output includes no tokens, push a 0 (VM Number).                               |
...
| 0-byte, mutable NFT; 0 fungible                    | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee` | `0x00`                                                                               | (empty item)                                      |
| 0-byte, mutable NFT; 4294967295 fungible           | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee` | `0x00`                                                                               | `feffffffff`                                      |
| 1-byte, mutable NFT; 4294967296 fungible           | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee` | `cc`                                                                                 | `ff0000000001000000`                              |
| 2-byte, mutable NFT; 9223372036854775807 fungible  | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee` | `cccc`                                                                               | `ffffffffffffffff7f`                              |
| 10-byte, mutable NFT; 1 fungible                   | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee` | `cccccccccccccccccccc`                                                               | `01`                                              |
| 40-byte, mutable NFT; 252 fungible                 | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1dee` | `cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc`   | `fc`                                              |
...
**For security, wallets should enable `SIGHASH_UTXOS` when participating in multi-party transactions involving tokens**. This includes both 1) transactions where signatures are collected from multiple entities and assembled into a single transaction, and 2) transactions that interact with multi-party covenants.
