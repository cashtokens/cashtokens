...
3. `commitment_length` – A **commitment length** (encoded in `CompactSize` format<sup>1</sup>). Optional field, `token_format` indicates whether it is skipped or read. If read, then it must encode a number greater than 0.
4. `commitment` – A **token commitment** byte string of `commitment_length` is required. Optional field, `token_format` indicates whether it is skipped or read.
5. `ft_amount` – a **token amount** (encoded as in `CompactSize` format) with a minimum value of `1` (`0x01`) and a maximum value equal to the maximum VM number, `9223372036854775807` (`0xffffffffffffff7f`). Optional field, `token_format` indicates whether it is skipped or read.
...
-- | -- | -- | -- | -- | -- | -- | -- | -- | --
0x10 (16) | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 | Fungible tokens
0x40 (64) | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | Non-fungible token with **immutable** capability
0x41 (65) | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 1 | Non-fungible token with **mutable** capability
0x42 (66) | 0 | 1 | 0 | 0 | 0 | 0 | 1 | 0 | Non-fungible token with **mint** capability
0x50 (80) | 0 | 1 | 0 | 1 | 0 | 0 | 0 | 0 | Fungible tokens and a non-fungible token with **immutable** capability
0x51 (81) | 0 | 1 | 0 | 1 | 0 | 0 | 0 | 1 | Fungible tokens and a non-fungible token with **mutable** capability
0x52 (82) | 0 | 1 | 0 | 1 | 0 | 0 | 1 | 0 | Fungible tokens and a non-fungible token with **mint** capability
0x60 (96) | 0 | 1 | 1 | 0 | 0 | 0 | 0 | 0 | Non-fungible token with **immutable** capability and a **commitment**
0x61 (97) | 0 | 1 | 1 | 0 | 0 | 0 | 0 | 1 | Non-fungible token with **mutable** capability and a **commitment**
0x62 (98) | 0 | 1 | 1 | 0 | 0 | 0 | 1 | 0 | Non-fungible token with **mint** capability and a **commitment**
0x70 (112) | 0 | 1 | 1 | 1 | 0 | 0 | 0 | 0 | Fungible tokens and a non-fungible token with **immutable** capability and a **commitment**
0x71 (113) | 0 | 1 | 1 | 1 | 0 | 0 | 0 | 1 | Fungible tokens and a non-fungible token with **mutable** capability and a **commitment**
0x72 (114) | 0 | 1 | 1 | 1 | 0 | 0 | 1 | 0 | Fungible tokens and a non-fungible token with **mint** capability and a **commitment**
