# CHIP-2022-02-CashTokens: Token Primitives for Bitcoin Cash
        ...
        Latest Revision Date: 2022-07-01
...
Token primitives are introduced, a `PREFIX_TOKEN` codepoint and token encoding is specified, and six new token inspection opcodes are introduced. Transaction validation is modified to support the new prefix codepoint, `SIGHASH_SCRIPTPUBKEYS` is defined, and CashAddress `types` with token support are specified.
...
2. `<has_nft>` – A byte indicating the presences and capability of a non-fungible token:
   ...
   2. `0x01` – the **`minting` capability** – the encoded non-fungible token is a **minting token**.
   3. `0x02` – the **`mutable` capability** – the encoded non-fungible token is a **mutable token**.
   4. `0x11` – no capability – the encoded non-fungible token is an **immutable token**.
3. `commitment_length` (if an NFT is present) – A **commitment length** (encoded in `CompactSize` format<sup>1</sup>) with a minimum value of `0` (`0x00`) and maximum value of `9962` (`0xfdea26`)<sup>2</sup>.
4. `commitment` – If `commitment_length` is non-zero, a **token commitment** of `commitment_length` is required.
5. `ft_amount` – a **token amount** (encoded as in `CompactSize` format) with a minimum value of `0` (`0x00`) and a maximum value equal to the maximum VM number, `9223372036854775807` (`0xffffffffffffffff7f`).
...
2. While `standard` `commitment_length`s are limited to `40` (`0x28`), `commitment_length` is limited at the consensus level only by the `10000` byte limit on locking bytecode (`MAX_SCRIPT_SIZE`). Because the minimum token prefix overhead is `38`, the maximum valid `commitment_length` is `9962` (`PREFIX_TOKEN`: 1, `category_id`: 32, `has_nft`: 1, `commitment_length`: 3, `commitment`: N, `ft_amount`: 1; `10000=1+32+1+3+1+N` -> `N=10000-38=9962`).
...
For a transaction to be considered **standard** for network relay (A.K.A. `isStandard` validation), all UTXO and output token prefixes must have a `commitment_length` less than or equal to `40` bytes. (See [Non-Fungible Token Commitment Length](#non-fungible-token-commitment-length).)
...
| 0-byte, mutable NFT; 0 fungible                    | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d020000`                                                                                                 |
| 0-byte, mutable NFT; 4294967295 fungible           | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0200feffffffff`                                                                                         |
| 1-byte, mutable NFT; 4294967296 fungible           | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0201ccff0000000001000000`                                                                               |
| 2-byte, mutable NFT; 9223372036854775807 fungible  | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0202ccccffffffffffffffff7f`                                                                             |
| 10-byte, mutable NFT; 1 fungible                   | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d020acccccccccccccccccccc01`                                                                             |
| 40-byte, mutable NFT; 252 fungible                 | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0228ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccfc`                 |
| 0-byte, minting NFT; 0 fungible                    | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d010000`                                                                                                 |
| 0-byte, minting NFT; 253 fungible                  | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0100fdfd00`                                                                                             |
| 1-byte, minting NFT; 65535 fungible                | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0101ccfdffff`                                                                                           |
| 2-byte, minting NFT; 65536 fungible                | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0102ccccfe00000100`                                                                                     |
| 10-byte, minting NFT; 4294967297 fungible          | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d010accccccccccccccccccccff0100000001000000`                                                             |
| 40-byte, minting NFT; 9223372036854775807 fungible | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0128ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccffffffffffffffff7f` |

#### Nonstandard Token Prefix Encodings

These encodings are valid but nonstandard due to excessive `commitment_length`s.
...
| 41-byte, mutable NFT; 252 fungible                 | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0229ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccfc`                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 41-byte, minting NFT; 9223372036854775807 fungible | `d01d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0129ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccffffffffffffffff7f`                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 253-byte, immutable NFT; 0 fungible                | `` |

#### Invalid Token Prefix Encodings

| Reason                                                                                                 | Encoded (Hex)                                                                            |
| ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| Token prefix must encode at least one token                                                            | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0000`                 |
| Token prefix requires a token category ID                                                              | `ef`                                                                                     |
| Token category IDs must be 32 bytes                                                                    | `ef1d1d1d1d`                                                                             |
| Category must be followed by token information                                                         | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d`                     |
| No fungible amount specified (has no NFT)                                                              | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d00`                   |
| Commitment length must be specified (immutable token)                                                  | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d11`                     |
| Commitment length must be specified (mutable token)                                                    | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d02`                   |
| Commitment length must be specified (minting token)                                                    | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d01`                   |
| Not enough bytes remaining in locking bytecode to satisfy commitment length (0/1 bytes)                | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1101`                 |
| Not enough bytes remaining in locking bytecode to satisfy commitment length (mutable token, 1/2 bytes) | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0202cc`               |
| Not enough bytes remaining in locking bytecode to satisfy commitment length (mutable token, 0/1 bytes) | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0101`                 |
| Not enough bytes remaining in locking bytecode to satisfy commitment length (minting token, 1/2 bytes) | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d0102cc`               |
| Token amount must be specified                                                                         | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d00`                   |
| Token amount (9223372036854775808) may not exceed 9223372036854775807                                  | `ef1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d00ff0000000000000080` |
...
**By consensus, all node implementations must prune any PATFOs mined in blocks prior to the activation of [Token-Aware Transaction Validation](#token-aware-transaction-validation)**; PATFOs remain unspendable after activation. (Please note: the presence of PATFOs does not render a transaction invalid; until activation, valid blocks may contain PATFOs.)
...
| -------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `OP_UTXOTOKENCATEGORY`     | `0xce` (`206`) | Pop the top item from the stack as an input index (VM Number). Push the concatenation of the token category and capability of the Unspent Transaction Output (UTXO) spent by that input to the stack, where the mutable capability is represented by 2 (VM Number), the minting capability is represented by 1 (VM Number), and no capability is represented by 0 (VM Number). If the UTXO includes no tokens, push a 0 (VM Number). |
...
| `OP_OUTPUTTOKENCATEGORY`   | `0xd1` (`209`) | Pop the top item from the stack as an output index (VM Number). Push the concatenation of the token category and capability of the output at that index to the stack, where the mutable capability is represented by 2 (VM Number), the minting capability is represented by 1 (VM Number), and no capability is represented by 0 (VM Number). If the output includes no tokens, push a 0 (VM Number).                               |
| `OP_OUTPUTTOKENCOMMITMENT` | `0xd2` (`210`) | Pop the top item from the stack as an output index (VM Number). Push the token commitment of the output at that index to the stack. If the output includes a non-fungible token with a zero-byte commitment, push 0x00. If the output does not include a non-fungible token, push a 0 (VM Number). If the token commitment is longer than the stack item length limit, fail evaluation.                                              |
...
| 41-byte immutable NFT; 4294967295 fungible         | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d`   | `cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc` | `feffffffff`                                      |
| 520-byte immutable NFT; 0 fungible                 | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d`   | (520-byte element filled with `0xcc`)                                                | (empty item)                                      |
| 521-byte immutable NFT; 0 fungible                 | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d`   | Error: commitment is longer than the stack item length limit (fails evaluation)      | (empty item)                                      |
| 0-byte, mutable NFT; 0 fungible                    | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d02` | `0x00`                                                                               | (empty item)                                      |
| 0-byte, mutable NFT; 4294967295 fungible           | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d02` | `0x00`                                                                               | `feffffffff`                                      |
| 1-byte, mutable NFT; 4294967296 fungible           | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d02` | `cc`                                                                                 | `ff0000000001000000`                              |
| 2-byte, mutable NFT; 9223372036854775807 fungible  | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d02` | `cccc`                                                                               | `ffffffffffffffff7f`                              |
| 10-byte, mutable NFT; 1 fungible                   | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d02` | `cccccccccccccccccccc`                                                               | `01`                                              |
| 40-byte, mutable NFT; 252 fungible                 | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d02` | `cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc`   | `fc`                                              |
| 0-byte, minting NFT; 0 fungible                    | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d01` | `0x00`                                                                               | (empty item)                                      |
| 0-byte, minting NFT; 253 fungible                  | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d01` | `0x00`                                                                               | `fdfd00`                                          |
| 1-byte, minting NFT; 65535 fungible                | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d01` | `cc`                                                                                 | `fdffff`                                          |
| 2-byte, minting NFT; 65536 fungible                | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d01` | `cccc`                                                                               | `fe00000100`                                      |
| 10-byte, minting NFT; 4294967297 fungible          | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d01` | `cccccccccccccccccccc`                                                               | `ff0100000001000000`                              |
| 40-byte, minting NFT; 9223372036854775807 fungible | `1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d1d01` | `cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc`   | `ffffffffffffffff7f`                              |
...
This specification limits the length of non-fungible token commitments in standard transactions to `40` bytes; this restrains excess growth of the UTXO set and reduces the resource requirements of typical wallets and indexers.

By committing to a hash, contracts can commit to an unlimited collection of data (e.g. using a merkle tree). For resistance to [birthday attacks](https://lists.linuxfoundation.org/pipermail/bitcoin-dev/2016-January/012234.html), covenants should typically use `32` byte hashes. This proposal expands this minimum requirement by `8` bytes to include an additional (padded, maximum-length) VM number. This is particularly valuable for covenants that are optimized to use multiple types of commitment structures and must concisely indicate their current internal "mode" to other contracts (e.g. re-organizing an unbalanced merkle tree of contract state for efficiency when the covenant enters "voting" mode). This additional 8 bytes also provides adequate space for higher-level standards to specify prefixes for committed hashes (e.g. marking identifiers to content-addressable storage).

For nonstandard transactions, commitment length is constrained only by the existing 10,000 byte limit on locking bytecode length; this is the maximum commitment length that can be encoded while maintaining backwards-compatibility with existing transaction parsing implementations.

As nonstandard transactions may already contain outputs with maximum-length locking bytecode, **any additional limitation on nonstandard commitment lengths would have no impact on UTXO set growth**, but such a limit may prevent the standardness limit from being increased in future, backwards-compatible upgrades, resulting in unnecessary protocol complexity and higher implementation costs.

Specifically, a future upgrade may relax the standardness requirements of transaction outputs to allow arbitrary locking bytecode, allowing covenants to operate without the unnecessary overhead of Pay to Script Hash (P2SH). For a covenant to validate a P2SH output, the redeem bytecode must be public at payment time; including the hash of the redeem bytecode is strictly wasteful – it's only purpose is to ensure the transaction passes output standardness validation. For this same reason, some commitments managed by covenants will also be wasteful if contracts are forced (by standardness validation) to commit to hashes instead of slightly larger segments of raw data. Therefore if future upgrades relax locking bytecode standardness requirements, such upgrades may also relax commitment length standardness requirements. By supporting larger nonstandard commitment lengths, this proposal minimizes future protocol complexity and technical debt.

Alternatively, this proposal could limit commitment lengths in nonstandard transactions (by consensus) to `520` bytes – this lower limit would ensure that `OP_UTXOTOKENCOMMITMENT` and `OP_OUTPUTTOKENCOMMITMENT` can never fail due to an oversized push (exceeding the 520 byte stack item length limit). Limiting commitment lengths to prevent inspection operation failure would break from the existing behavior of [all other inspection operations](https://gitlab.com/GeneralProtocols/research/chips/-/blob/982694e9d75f01218054c33fe58ff14ca846d07c/CHIP-2021-02-Add-Native-Introspection-Opcodes.md#nullary-operations), where excessive length pushes already cause evaluation failure. Evaluation failure also enables backward-compatible expansion in future upgrades: if the stack item length limit is increased, the `OP_*TOKENCOMMITMENT` operations can safely support the new larger limit without impacting existing contracts (contracts can be written to rely on the failing behavior, but these contracts can only be interpreted as intentional; see [Interpretation of Signature Preimage Inspection](#interpretation-of-signature-preimage-inspection)). Notably, most [currently-known, post-quantum cryptographic signature schemes](https://en.wikipedia.org/wiki/Post-quantum_cryptography#Comparison) require public keys and signatures with lengths exceeding the existing stack item length limit; if a future upgrade added support for one or more of these signature schemes, it will likely also require an increase in the stack item length limit.

Because nonstandard transactions may include commitment lengths that exceed the current stack item length limit (520 bytes), the `OP_*TOKENCOMMITMENT` operations must be used with the same care required of `OP_ACTIVEBYTECODE`, `OP_UTXOBYTECODE`, `OP_INPUTBYTECODE`, and `OP_OUTPUTBYTECODE`; covenant developers must ensure that an attacker cannot force the covenant into a state in which further covenant execution is impossible (e.g. all spending paths require reading from an invalid input/output index or reading a commitment longer than 520 bytes). Though this is not typically a risk for covenants that validate output token commitments, it could be possible in rare cases where, for example, 1) the covenant requires reading from it's own token commitment for every available spending path, and 2) users are somehow allowed to attach arbitrary, unrelated tokens to the covenant without first reading from the attached token's commitment (in the transaction that initially attaches the token).
...
- **v2.1.0 – 2022-7-1** (current)
  - Expand rationale
  - Encode minting capability as `0x01` and mutable capability as `0x02`
